...
public class MyConnector {
    public static void main(String... args) {
        try {
//           createUser("baburao", "baburao@123#", "Admin");
//            selectAll();
//            selectOne(1);
//            updateUser(1,"bibhustha","bibhu1@123#","STD");
//            deleteUser(1);

            authenticate("baburao","baburao@123#");
//            countUser("ADMIN");
    ...
    public static Connection connect() throws Exception {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/rejina", "root", "");
